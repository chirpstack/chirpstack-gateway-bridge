...
func GetRouterConfig(region band.Name, netIDs []lorawan.NetID, joinEUIs [][2]lorawan.EUI64, freqMin, freqMax uint32, config gw.GatewayConfiguration) (RouterConfig, error) {
	c := RouterConfig{
